...
@Component({
  ...
  `,
  styles: [`
    :host{display:block}.request-hub{gap:20px}.request-hub__hero{display:flex;align-items:flex-start;justify-content:space-between;gap:24px}.request-hub__hero>div{display:grid;gap:6px}.request-hub__hero h1,.request-hub__hero p{margin:0}.request-hub__hero h1{color:var(--av-color-text-heading,#0d343f);font-size:32px;line-height:1.15}.request-hub__hero p,.request-hub__acl p{max-width:720px;color:var(--av-color-text-muted,#66788a);font-size:13px;line-height:1.55}.request-hub__acl{display:flex;align-items:center;justify-content:space-between;gap:24px;padding:22px}.request-hub__acl>div{display:grid;gap:6px}.request-hub__acl h2,.request-hub__acl p{margin:0}.request-list{display:grid;gap:14px}.request-hub__table{min-width:760px}.request-hub__cards{display:none}@media(max-width:767px){.request-hub__hero h1{font-size:26px}.request-hub__acl{display:grid}.request-hub__acl .baseline-button{width:100%}.baseline-table-wrap{display:none}.request-hub__cards{display:grid;gap:12px}}
  `],
...
export class FundsRequestHubComponent {
  ...
  readonly sortOptions:readonly CustomerSortOption[]=[{value:'name-asc',label:'Name: A-Z'},{value:'available-desc',label:'Available financing: high to low'},{value:'available-asc',label:'Available financing: low to high'},{value:'due-asc',label:'Due date: earliest'},{value:'due-desc',label:'Due date: latest'}]
