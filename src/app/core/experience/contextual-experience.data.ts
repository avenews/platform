...
export const EXPERIENCES: readonly PortalExperience[] = [
  ...
  },
  {
    ...
    productName: 'Invoice Financing - Partner Buyer',
    switcherLabel: 'Invoice Financing - Partner Buyer',
    roleLabel: 'Partner Buyer',
    description: 'Upload invoice batches, review obligations, and manage participating Suppliers.',
    homeHeading: 'Invoice Financing - Partner Buyer',
    homeIntro: 'The Partner Buyer uploads invoices. The Client Supplier submits the Funds Request from the resulting Dynamic Period.',
    primaryActionLabel: 'Upload invoices',
    primaryActionKind: 'upload-invoices',
    metrics: [
      { label: 'Invoices Uploaded', value: '128', helper: 'This payment cycle' },
      { label: 'Supplier Businesses', value: '42', helper: '38 active, 4 onboarding' },
      { label: 'Next Obligation', value: 'KES 8,420,000', helper: 'Due 15 Sep 2026' },
    ],
    records: [
      { title: 'August supplier batch', subtitle: 'Uploaded by Daniel Otieno - 12 Aug 2026', amountLabel: 'Imported', amount: '37 of 40 invoices', status: '3 need attention', statusTone: 'status-warning', actionLabel: 'View upload result', actionKind: 'view-invoice-uploads' },
      { title: '15 Sep 2026 obligation', subtitle: '18 Client Suppliers', amountLabel: 'Invoice value', amount: 'KES 8,420,000', status: 'Upcoming', statusTone: 'status-info', actionLabel: 'View obligations', actionKind: 'view-obligations' },
    ],
  },
]
