...
const ABF_PERIODS: readonly CustomerFinancingPeriod[] = [
  {
    ...
    instalments: [],
    note: 'Funds request submitted and awaiting approval.',
  },
  {
...
const INF_PERIODS: readonly CustomerFinancingPeriod[] = [
  {
    ...
    instalments: [],
    note: 'A funds request has been submitted and is awaiting approval.',
  },
  {
    id: 'inf-twiga-live',
    ...
    instalments: [],
    note: 'Buyer payment will settle this financing period through your Avenews Clearing Account.',
  },
  {
...
export const CUSTOMER_WORKSPACES: readonly CustomerWorkspace[] = [
  {
    ...
    availableMetricHelper: 'Available for approved purchases',
    outstandingMetricLabel: 'Outstanding Amount',
    outstandingMetricValue: 1200000,
    outstandingMetricHelper: 'Across active financing',
  ...
  },
  {
    ...
    relationshipHeading: 'Suppliers',
    relationshipIntro: 'Choose a supplier to view available financing or request funds.',
    relationshipNoun: 'Supplier',
    availableMetricLabel: 'Available Financing',
    availableMetricValue: 1741000,
    availableMetricHelper: 'Across approved suppliers',
    outstandingMetricLabel: 'Outstanding Amount',
    outstandingMetricValue: 649000,
    outstandingMetricHelper: 'Across active financing periods',
    dueMetricLabel: 'Payments Due',
    dueActionLabel: 'View payments due',
    dueDateColumnLabel: 'Repayment Due Date',
    totalRepaidColumnLabel: 'Total Repaid',
  ...
  },
  {
    ...
    relationshipHeading: 'Buyers',
    relationshipIntro: 'Choose a buyer to view financing periods, upload invoices or request funds.',
    relationshipNoun: 'Buyer',
    availableMetricLabel: 'Available Financing',
    availableMetricValue: 970000,
    availableMetricHelper: 'Across eligible financing periods',
    outstandingMetricLabel: 'Outstanding Amount',
  ...
  },
  {
    ...
    relationshipNavLabel: 'Buyers',
    relationshipHeading: 'Buyers',
    relationshipIntro: 'Choose a buyer to view available financing or request funds for an invoice.',
    relationshipNoun: 'Buyer',
    availableMetricLabel: 'Available Financing',
    availableMetricValue: 1070000,
    availableMetricHelper: 'Across approved buyers',
    outstandingMetricLabel: 'Outstanding Amount',
