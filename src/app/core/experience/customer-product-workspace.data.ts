...
const ACL_PERIODS: readonly CustomerFinancingPeriod[] = [
  ...
  },
  {
    ...
    relationshipId: 'acl-general',
    relationshipName: 'Approved purchases',
    relationshipType: 'Agri Credit Line',
...
export const CUSTOMER_WORKSPACES: readonly CustomerWorkspace[] = [
  ...
  },
  {
    ...
    relationshipIntro: 'Choose an approved Supplier to see its sub-limit, financing periods and Supplier-scoped Funds Request.',
    ...
    relationships: [
      {
        ...
        helper: 'One live Supplier-scoped financing period.',
      ...
      },
      {
        ...
        helper: 'Fully Paid Invoice reimbursement can be used for the next eligible request.',
        fundsRequestUrl: ABF_FUNDS_REQUEST_DEMO_URL,
        fundsRequestEnabled: true,
        fundsRequestLabel: 'Request funds',
      },
      {
        ...
        used: 0,
        available: 600000,
        periodIds: ['abf-eastleigh-requested'],
        helper: 'A Supplier-scoped Funds Request is currently awaiting approval.',
        fundsRequestUrl: ABF_FUNDS_REQUEST_DEMO_URL,
        fundsRequestEnabled: true,
        fundsRequestLabel: 'Request funds',
      },
  ...
  },
  {
    ...
    relationshipIntro: 'Choose the Partner Supplier you are buying from, then request funds in that Supplier context.',
    ...
    relationships: [
      ...
      },
      {
        ...
        helper: 'An overdue financing period needs attention.',
        fundsRequestEnabled: true,
        fundsRequestLabel: 'Request funds',
      },
      {
        ...
        used: 0,
        available: 680000,
        periodIds: ['stf-seedco-repaid'],
        helper: 'The previous three-Instalment Financing Period has been fully repaid.',
        fundsRequestEnabled: true,
        fundsRequestLabel: 'Request funds',
      },
    ],
  ...
  },
  {
    ...
    relationshipIntro: 'Choose the Buyer relationship first, then request funds from an eligible Dynamic Period.',
    ...
    relationships: [
      {
        ...
        used: 850000,
        available: 650000,
        periodIds: ['inf-twiga-live', 'inf-twiga-requested'],
      ...
      },
      {
        ...
        used: 450000,
        available: 1550000,
        periodIds: ['inf-fresh-overdue', 'inf-fresh-repaid'],
  ...
  },
  {
    ...
    relationshipIntro: 'Choose an approved Buyer first, then request funds for one approved invoice.',
    relationshipNoun: 'Buyer',
    availableMetricLabel: 'Available Credit',
    ...
    relationships: [
      ...
      },
      {
        ...
        used: 0,
        available: 700000,
        periodIds: ['infx-nairobi-repaid'],
        helper: 'The previous one-invoice Financing Period has been fully repaid.',
        fundsRequestEnabled: true,
        fundsRequestLabel: 'Request funds',
      },
    ],
