...
const designLabTs = read('src/app/features/design-lab/design-lab.component.ts')
const designLabHtml = read('src/app/features/design-lab/design-lab.component.html')
const designLabCss = read('src/app/features/design-lab/design-lab.component.css')
const changelogData = read('src/app/shared/staging-changelog.data.ts')
...
requireText(shellHtml, 'routerLink="/design-lab"', 'Developer menu Design Lab link')
requireText(shellHtml, 'routerLink="/changelog"', 'Developer menu Changelog link')
...
requireText(shellCss, '.developer-tools {', 'Desktop-only Developer control')
...
requireText(rootStyles, '--av-color-text-heading', 'Official heading semantic token')
requireText(rootStyles, '--av-color-surface-border', 'Official border semantic token')
forbidText(rootStyles, '--av-color-heading', 'Obsolete heading token is not allowed in root styles')
forbidText(rootStyles, '--av-color-border', 'Obsolete border token is not allowed in root styles')
...
requireText(precisionCss, '.manage-users-head {\n    padding-right: 112px;', 'Developer-control clearance for Manage Users')
...
requireText(designLabTs, "readonly designSystemVersion = '1.9.0'", 'Design Lab package version')
requireText(designLabTs, "readonly designSystemCommit = '4dd1b7b28e9e9a7744c73eb9bb7c8dd1a560900e'", 'Design Lab pinned source commit')
requireText(designLabTs, "{ value: 'INF', label: 'Invoice Financing (INF)' }", 'Current INF product label')
requireText(designLabTs, "{ value: 'INFX', label: 'Invoice Financing Express (INFX)' }", 'Current INFX product label')
forbidText(designLabTs, 'Supplier Financing (INF)', 'Outdated INF label is not allowed in Design Lab')
forbidText(designLabTs, 'Supplier Financing Express (SFX)', 'Outdated SFX label is not allowed in Design Lab')
...
requireText(designLabCss, '--av-color-surface-border', 'Design Lab official border token')
forbidText(designLabCss, '--av-color-heading', 'Obsolete heading token is not allowed in Design Lab')
forbidText(designLabCss, '--av-color-border', 'Obsolete border token is not allowed in Design Lab')
requireText(designLabCss, '.design-lab__hero {\n    padding-right: 112px;', 'Developer-control clearance for Design Lab')
